                ...
                <?php foreach ($projectsToShow as $index => $project): ?>
                    <div class="xl:w-1/4 md:w-1/2 p-4">
                        <div class="bg-gray-100 p-6 rounded-lg h-full flex flex-col justify-between">
                            <div>
                                <img onclick="openModal('<?php echo $edu['image']; ?>')" class="w-full h-64 object-cover rounded mb-4 cursor-pointer hover:opacity-90 transition duration-300" src="<?php echo $edu['image']; ?>" alt="Project Image">
