...
<head>
    ...
    <link rel="icon" href="api/img/rocket.png">
    ...
    <section class="text-gray-600 body-font" id="about">
        <div class="container mx-auto flex px-10 py-10 md:flex-row flex-col items-center">
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                <img class="object-cover object-center rounded" src="api/img/ardit.jpg" alt="Ardit">
            </div>
            <div
                ...
                <div class="flex justify-center">
                    <a href="api/pdf/arditahmeti-cv.pdf" download
    ...
    <section class="text-gray-600 body-font bg-blue-100">
        <div class="container px-5 py-10 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                ...
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Discover Ardit Ahmeti's
                    Experiences</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-justify">
                    Over the past years, I have built a strong foundation in full-stack web development, WordPress
                    customization, and technology education.
                    Every project, internship, and teaching role has contributed to my growth, sharpening both my
                    technical skills and creative problem-solving abilities.
                    From developing dynamic websites to mentoring young minds in technology, each experience has fueled
                    my passion for innovation and continuous learning.
                    Explore my professional journey and see how I can bring value to your next project or collaboration.
                </p>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-6 text-center">
                ...
                <div
                    class="xl:w-1/4 lg:w-1/3 md:w-1/2 sm:w-full p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition">
                    <h2 class="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">
                        <?php echo $job['position']; ?>
                    </h2>
                    <p class="leading-relaxed text-base text-gray-600"><?php echo $job['company']; ?></p>
                    <p class="leading-relaxed text-base text-gray-500"><?php echo $job['duration']; ?></p>
                </div>
                <?php endforeach; ?>
            </div>
            ...
            <div class="flex justify-center mt-16">
                <a href="experience.php"
                    class="inline-flex text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">
