...
<body>
    ...
    <section class="flex flex-col items-center justify-center bg-blue-100 py-12 px-6">
        ...
        <div class="flex flex-wrap justify-center gap-6">
            <a href="arditahmeti-cv.pdf" download class="inline-flex items-center text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg transition">
                Here is my CV
