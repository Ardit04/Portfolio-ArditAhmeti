...
<body>
    ...
    <header class="text-gray-600 body-font bg-blue-100">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <img src="/img/rocket.png" class="w-5 h-5" alt="Logo">
            <span class="ml-3 text-xl"><b>Ardit Ahmeti</b> </span>
            </a>
            <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                <a href="home.php" class="mr-5 hover:text-gray-900">About</a>
                <a href="Experiences.php" class="mr-5 hover:text-gray-900">Experiences</a>
                <a href="projects.php" class="mr-5 hover:text-gray-900">Projects</a>
