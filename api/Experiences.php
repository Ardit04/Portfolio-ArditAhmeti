...
<body>
    ...
    <section class="flex flex-col items-center justify-center bg-blue-100 py-12 px-6">
        ...
        <div class="flex flex-wrap justify-center gap-6">
            ...
            <a href="projects.php" class="inline-flex items-center text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg transition">
